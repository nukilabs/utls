...
import (
	...
	"github.com/nukilabs/utls/internal/tls13"
)
...
func (c *Conn) makeClientHelloForApplyPreset() (*clientHelloMsg, *keySharePrivateKeys, *echClientContext, error) {
	...
	maxVersion := config.maxSupportedVersion(roleClient, c.quic != nil)
...
func (c *UConn) echTranscriptMsg(outer *clientHelloMsg, echCtx *echClientContext) (err error) {
	...
	// See https://github.com/nukilabs/utls/blob/e430876b1d82fdf582efc57f3992d448e7ab3d8a/ech.go#L276-L283
