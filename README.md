...
[![Build Status](https://github.com/nukilabs/utls/actions/workflows/go.yml/badge.svg?branch=master)](https://github.com/nukilabs/utls/actions/workflows/go.yml) 
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/nukilabs/utls#UConn)
---
...
so you are encouraged to use [godoc](https://godoc.org/github.com/nukilabs/utls#UConn).
...
It LGTM, but please open up Wireshark and check. If you see something — [say something](https://github.com/nukilabs/utls/issues).
...
There sure are. If you found one that approaches practicality at line speed — [please tell us](https://github.com/nukilabs/utls/issues).
...
# Client Hello IDs
See full list of `clientHelloID` values [here](https://godoc.org/github.com/nukilabs/utls#ClientHelloID).  
...
1. Import this library (e.g. `import tls "github.com/nukilabs/utls"`)
